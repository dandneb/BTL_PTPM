    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Sửa thương hiệu</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 ms-auto me-auto">
            <a class="btn btn-danger mt-2 mb-2">Sửa thương hiệu</a>
            <div style="color: red">
            ...
            <form action="" method="post" class="needs-validation dropzone" id="myAwesomeDropzone" enctype="multipart/form-data" onsubmit="return validateForm()" novalidate>
                <div class="row">
                    ...
                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            <label class="form-label" for="validationCustom01">Sửa tên thương hiệu</label>
                            <input type="text" class="form-control" value="<?php echo $ten_thuonghieu ?>" name="ten_thuonghieu" id="validationCustom01" placeholder="Tên thương hiệu" required>
                            <div class="invalid-feedback">
                                Hãy nhập tên thương hiệu cần sửa!
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <button class="btn btn-primary mt-2" id="submit-all" name="submit" type="submit">Sửa thương hiệu</button>
                    </div>
                </div>
            </form>
        </div>
