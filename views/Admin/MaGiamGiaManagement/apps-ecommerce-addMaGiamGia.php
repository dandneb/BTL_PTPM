...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 ms-auto me-auto">
            <a class="btn btn-danger mt-2 mb-2">Thêm mã giảm giá</a>
            <div style="color: red">
            ...
            <form action="" method="POST" class="needs-validation dropzone" id="myAwesomeDropzone" onsubmit="return validateForm()" novalidate>
                <div class="row">

                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            <label class="form-label" for="validationCustom01">Nhập mã giảm giá</label>
                            <input type="text" class="form-control" name="magiamgia" id="magiamgia" placeholder="Mã giảm giá" required>
                            <div class="invalid-feedback">
                                Hãy nhập mã giảm giá!
                            </div>
                            <span id="maGiamGiaHelp" class="p-12 mt-2"></span>
                        </div>
                    </div>

                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            <label class="form-label" for="validationCustom01">Nhập ngày bắt đầu</label>
                            <input type="date" class="form-control" name="ngaybatdau" id="ngaybatdau" placeholder="Ngày bắt đầu" required>
                            <div class="invalid-feedback">
                                Hãy nhập ngày bắt đầu được dùng mã giảm giá!
                            </div>
                    ...
                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="hansudung" id="hansudung" placeholder="Hạn sử dụng" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="soluotsudung" id="soluotsudung" placeholder="Mã giảm giá" required>
                            <div class="invalid-feedback">
                                Hãy nhập số lượng sử dụng!
                            </div>
                    ...
                    <div class="col-md-6 me-0">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="giam" id="giam" placeholder="Giảm giá (%)" required>
                            <div class="invalid-feedback">
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <button class="btn btn-primary mt-2" id="submit-all" name="submit" type="submit">Thêm mã giảm giá</button>
                    </div>
                </div>
            </form>
        </div>
