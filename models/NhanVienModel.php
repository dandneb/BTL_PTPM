...
class NhanVienModel extends Model{
    public function getALLProducts(){
        $dbh = $this->connectDb();
        $stmt = $dbh->prepare("Select t1.id_nuochoa, ten_nuochoa, ten_thuonghieu, ngaybat_dauban, t3.soluong, gia_ban, gia_nhap, t1.status, IFNULL(sum(t4.soluong),0) as soluongdaban, t1.id_thuonghieu from tb_nuochoa t1 
